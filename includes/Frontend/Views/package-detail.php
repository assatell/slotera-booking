                ...
                <div class="sltr-package-contact-aside">
                    ...
                    <?php if ($sltr_contact_map_url !== '') : ?>
                        <p class="sltr-package-contact-map-link">
                            <a href="<?php echo $sltr_contact_map_url; ?>" target="_blank" rel="noopener noreferrer" data-sltr-google-maps-popup>Google Maps</a>
                        </p>
                    <?php endif; ?>
                    ...
                    <?php if ($sltr_contact_socials) : ?>
                        <div class="sltr-package-contact-details sltr-package-contact-socials" aria-label="<?php esc_attr_e('Social links', 'slotera-booking'); ?>">
                            <?php foreach ($sltr_contact_socials as $social) : if (!is_array($social)) continue; ?>
                                ...
                                ?>
                                <a class="sltr-package-social-link" href="<?php echo $sltr_social_url; ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr($sltr_social_labels[$sltr_social_platform]); ?>">
                                    <?php if ($sltr_social_platform === 'instagram') : ?>
                                    ...
                                    <?php elseif ($sltr_social_platform === 'facebook') : ?>
                                    ...
                                    <?php elseif ($sltr_social_platform === 'linkedin') : ?>
                                    ...
                                    <?php elseif ($sltr_social_platform === 'x') : ?>
                                    ...
                                    <?php elseif ($sltr_social_platform === 'youtube') : ?>
