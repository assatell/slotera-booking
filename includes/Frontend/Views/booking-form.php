        ...
        <div class="sltr-packages">
            <?php if (!empty($packages)) : ?>
                <?php foreach ($packages as $package) : ?>
                    ...
                    $fixed_day_label = trim((string) ($active_mode_config['full_day_singular_label'] ?? ''));
                    $fixed_days_label = trim((string) ($active_mode_config['full_day_plural_label'] ?? ''));
    ...
    <div class="sltr-step" data-step="2" style="display:none;">
        ...
        <div class="sltr-calendar" id="sltr-calendar">
            <div class="sltr-calendar-header">
                <button type="button" class="sltr-calendar-prev" aria-label="<?php echo esc_attr(sltr_t('Previous month')); ?>"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M15 5l-7 7 7 7" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
                <strong class="sltr-calendar-title"></strong>
                <button type="button" class="sltr-calendar-next" aria-label="<?php echo esc_attr(sltr_t('Next month')); ?>"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M9 5l7 7-7 7" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
            </div>
