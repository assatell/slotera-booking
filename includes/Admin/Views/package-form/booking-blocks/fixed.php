<?php if (!defined('ABSPATH')) { exit; } ?>
                        <section class="sltr-booking-block <?php echo esc_attr($sltr_active_mode === 'fixed' ? 'is-active' : ''); ?>" data-mode="fixed">
                            ...
                            <div class="sltr-booking-block-body">
                                ...
                                <p><label><?php esc_html_e('Day label (singular)', 'slotera-booking'); ?></label><br>
                                    <input type="text" class="regular-text" maxlength="60" name="mode_config[fixed][full_day_singular_label]" value="<?php echo esc_attr((string) $sltr_mode_value('fixed', 'full_day_singular_label', '')); ?>" placeholder="day"><br>
                                    <span class="description"><?php esc_html_e('Optional replacement used after 1, for example päev.', 'slotera-booking'); ?></span>
                                </p>
                                <p><label><?php esc_html_e('Day label (plural)', 'slotera-booking'); ?></label><br>
                                    <input type="text" class="regular-text" maxlength="60" name="mode_config[fixed][full_day_plural_label]" value="<?php echo esc_attr((string) $sltr_mode_value('fixed', 'full_day_plural_label', '')); ?>" placeholder="days"><br>
                                    <span class="description"><?php esc_html_e('Optional replacement used after 2 or more, for example päeva.', 'slotera-booking'); ?></span>
                                </p>
