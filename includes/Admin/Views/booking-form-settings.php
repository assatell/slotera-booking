...
<div class="wrap sltr-admin">
    <h1><?php esc_html_e('Booking Form', 'slotera-booking'); ?></h1>
                ...
                <?php foreach ($fields as $key => $field) : ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($locked) : ?>
                                <input type="hidden" name="booking_form_<?php echo esc_attr($key); ?>_enabled" value="1">
                            <?php endif; ?>
                        </td>
                        <td>
                            <label>
                            ...
                            <?php if ($locked) : ?>
                                <input type="hidden" name="booking_form_<?php echo esc_attr($key); ?>_required" value="1">
                            <?php endif; ?>
                        </td>
